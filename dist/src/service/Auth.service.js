...
exports.authService = {
    register: function (email, password, name) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    token = jsonwebtoken_1.default.sign({ userId: user.id, role: user.role }, SECRET_KEY, {
                        expiresIn: "1h",
                    });
